...
const LeadsTable = ({
  ...
  return <>
            ...
            {leads.map(lead => <TableRow key={lead.id}>
                ...
                <TableCell>
                  <div className="flex items-center space-x-2">
                    ...
                    {isOrganicLead(lead) && hasDeviceData(lead) && <Badge variant="outline" className="text-xs bg-yellow-50 text-yellow-700">
                ...
                <TableCell>
                  {lead.created_at && <span className="text-sm text-gray-600">
                ...
                <TableCell>
                  {lead.last_message && <div className="flex items-center space-x-2 max-w-xs">
                ...
                <TableCell>
                  <div className="flex flex-col space-y-1">
                    {hasDeviceData(lead) && <Badge variant="outline" className="text-xs bg-green-50 text-green-700">
                        Dispositivo
                      </Badge>}
                    {lead.utm_source && lead.utm_source !== 'whatsapp' && <Badge variant="outline" className="text-xs bg-blue-50 text-blue-700">
                        UTMs
                      </Badge>}
                    {lead.facebook_ad_id && <Badge variant="outline" className="text-xs bg-purple-50 text-purple-700">
                        Facebook
                      </Badge>}
                  </div>
                </TableCell>
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {isOrganicLead(lead) && hasDeviceData(lead) && <DropdownMenuItem onClick={() => handleRecorrelation(lead)}>
      ...
      <LeadRecorrelationDialog lead={recorrelationLead} isOpen={isRecorrelationOpen} onClose={() => {
