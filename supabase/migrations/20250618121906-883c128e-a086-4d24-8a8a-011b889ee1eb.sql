...
-- 6. Criar políticas RLS básicas para pending_leads (sem user_id, então permitir acesso geral)
...
-- 7. Criar políticas RLS básicas para device_data (sem user_id, então permitir acesso geral)
...
-- 8. Criar políticas RLS básicas para utm_clicks (sem user_id, então permitir acesso geral)
